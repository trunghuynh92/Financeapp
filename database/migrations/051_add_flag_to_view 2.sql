-- ============================================================================
-- MIGRATION 051: Add flag columns and missing fields to main_transaction_details view
-- Purpose: Include is_flagged and other missing columns in the view
-- Date: 2025-01-13
-- ============================================================================
...
COMMENT ON VIEW main_transaction_details IS 'Complete view of main transactions with all related information including flag status, projects, and original transaction metadata';
