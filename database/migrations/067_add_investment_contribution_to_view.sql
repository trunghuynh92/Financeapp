-- ============================================================================
-- MIGRATION 067: Add investment_contribution_id to main_transaction_details view
-- Purpose: Include investment_contribution_id in the view so UI can display matched status
-- Date: 2025-01-19
-- ============================================================================
...
SELECT
  ...
  mt.investment_contribution_id,  -- *** ADDED: Link to investment contribution ***
  mt.is_flagged,
  mt.flagged_at,
  mt.flagged_by,
  mt.flag_note,
...
COMMENT ON VIEW main_transaction_details IS 'Complete view of main transactions with all related information including investment contributions, flag status, projects, and original transaction metadata';
