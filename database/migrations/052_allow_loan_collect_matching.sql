-- Migration 052: Allow LOAN_COLLECT matching
-- Purpose: Enable LOAN_COLLECT ↔ LOAN_COLLECT matching for loan payment transactions
-- Created: 2025-11-14

-- Update validate_transfer_match function to allow LOAN_COLLECT ↔ LOAN_COLLECT matching
...
BEGIN
    ...
    RAISE NOTICE 'Added LOAN_COLLECT ↔ LOAN_COLLECT matching support';
END $$;
