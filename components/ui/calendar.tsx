  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: "text-muted-foreground rounded-md w-9 font-normal text-xs flex items-center justify-center",
        week: "flex w-full mt-2",
        day_button: cn(
          buttonVariants({ variant: "ghost" }),
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-accent hover:text-accent-foreground"
        ),
        day: "relative h-9 w-9 p-0 text-center text-sm flex items-center justify-center",
        selected:
